...
namespace Mapper
{
    public class ValueMapper
    {
        public ValueMapper(double value1Left, double value1Right, double value2Left, double value2Right)
        {
            ...
            Range1 = new ValueRange(Math.Max(value1Right, value1Left), Math.Min(value1Right, value1Left));
            Range2 = new ValueRange(Math.Max(value2Right, value2Left), Math.Min(value2Right, value2Left));
            CalculateRatos();
        }

        public ValueMapper() : this(-1, 1, -1, 1)
        { }
        public ValueRange Range1 { get; private set; }
        public void SetRange1(double left, double right)
        {
            ...
            reverseMap = IsSameDirection();
            Range1 = new ValueRange(Math.Max(right, left), Math.Min(right, left));
            CalculateRatos();
        }
        ...
        public ValueRange Range2 { get; private set; }
        public void SetRange2(double left, double right)
        {
            ...
            reverseMap = IsSameDirection();
            Range2 = new ValueRange(Math.Max(right, left), Math.Min(right, left));
            CalculateRatos();
        }
