...
namespace Mapper
{
    public class ScreenToCoordinateMapper : IScreenToCoordinateMapper
    {
        ...
        //}
        public ScreenToCoordinateMapper(double screenLeft, double screenRight, double coordinateXLeft, double coordinateXRight,
                                        double screenTop, double screenBottom, double coordinateYTop, double coordinateYBottom)
        {
